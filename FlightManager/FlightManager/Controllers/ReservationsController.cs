...
namespace FlightManager.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            ViewData["FlightId"] = new SelectList(_context.Flights, "Id", "UniqueNumber");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FlightId,PassangersCount")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FlightId,PassangersCount")] Reservation reservation)
        {
